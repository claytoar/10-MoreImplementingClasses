    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        self.h_rect = rg.Rectangle(rg.Point(intersection_center.x - (0.5 * width),
                                       intersection_center.y - (0.5 * letter_thickness)),
                              rg.Point(intersection_center.x + (0.5 * width),
                                       intersection_center.y + (0.5 * letter_thickness)))
        self.v_rect = rg.Rectangle(rg.Point(intersection_center.x - (0.5 * letter_thickness),
                                       intersection_center.y - (0.5 * letter_thickness)),
                              rg.Point(intersection_center.x + (0.5 * letter_thickness),
                                       intersection_center.y + (height - (0.5 * letter_thickness))))
    ...
    def clone(self):
        ...
        new_t = CapitalT(intersection, width, height, thickness)
